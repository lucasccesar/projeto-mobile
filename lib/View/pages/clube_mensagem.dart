      ...
      body: Column(
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?wuhadaiuwhdawhduwahduawhdawiuhdawuwdhawiwudhwaudhawuidhwaduahdiwauhdwauidhawiduahdaudhawuidahwiudadaidhwuaidhaiudhaiduh', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Eu', texto: 'Oi, tudo ótimo! E você?', hora: '10:01', isMe: true),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: false),
              ClubeMensagemWidget(autor: 'Molodas', texto: 'Olá, tudo bem?', hora: '10:00', isMe: true),
            ],
          ),
        ),
